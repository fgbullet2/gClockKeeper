...
%>
<%
    sql = "SELECT UserInfo.FirstName, UserInfo.LastName, TimeInOut.TimeIn, TimeInOut.TimeOut, TimeInOut.Late, UserInfo.Dept, TimeInOut.DateInOut, TimeInOut.Notes  FROM TimeInOut INNER JOIN UserInfo ON TimeInOut.UserID = UserInfo.UserID  "
